...
from Lorenz96_Env import Lorenz96Env
...
def make_env(env_id, rank, integ_step, noise, seed=0):
    ...
    """
    def _init():
        env = Lorenz96Env(integ_steps = integ_step, Nx = 40, F = 7)
        env.seed(seed + rank)
        return env
...
def main(args):
    ...
    model.learn(total_timesteps=args.total_timesteps, log_interval=100, progress_bar=False, tb_log_name="PPO_MLP_L96", callback=callback)
    model.save(args.log_dir+"PPO_Lorenz96")
